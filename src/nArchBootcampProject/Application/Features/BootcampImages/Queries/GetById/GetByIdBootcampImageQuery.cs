...
public class GetByIdBootcampImageQuery : IRequest<GetByIdBootcampImageResponse>, ISecuredRequest
{
    ...
    public class GetByIdBootcampImageQueryHandler : IRequestHandler<GetByIdBootcampImageQuery, GetByIdBootcampImageResponse>
    {
        ...
        public GetByIdBootcampImageQueryHandler(IMapper mapper, IBootcampImageRepository bootcampImageRepository, BootcampImageBusinessRules bootcampImageBusinessRules)
        {
            _mapper = mapper;
        ...
        public async Task<GetByIdBootcampImageResponse> Handle(GetByIdBootcampImageQuery request, CancellationToken cancellationToken)
        {
