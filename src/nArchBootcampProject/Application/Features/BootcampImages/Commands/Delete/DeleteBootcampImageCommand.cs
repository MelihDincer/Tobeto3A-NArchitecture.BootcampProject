...
public class DeleteBootcampImageCommand : IRequest<DeletedBootcampImageResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class DeleteBootcampImageCommandHandler : IRequestHandler<DeleteBootcampImageCommand, DeletedBootcampImageResponse>
    {
        ...
        public DeleteBootcampImageCommandHandler(IMapper mapper, IBootcampImageRepository bootcampImageRepository,
        ...
        public async Task<DeletedBootcampImageResponse> Handle(DeleteBootcampImageCommand request, CancellationToken cancellationToken)
        {
