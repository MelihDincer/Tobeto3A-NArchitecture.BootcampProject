...
public class UpdateBootcampImageCommand : IRequest<UpdatedBootcampImageResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class UpdateBootcampImageCommandHandler : IRequestHandler<UpdateBootcampImageCommand, UpdatedBootcampImageResponse>
    {
        ...
        public UpdateBootcampImageCommandHandler(IMapper mapper, IBootcampImageRepository bootcampImageRepository,
        ...
        public async Task<UpdatedBootcampImageResponse> Handle(UpdateBootcampImageCommand request, CancellationToken cancellationToken)
        {
