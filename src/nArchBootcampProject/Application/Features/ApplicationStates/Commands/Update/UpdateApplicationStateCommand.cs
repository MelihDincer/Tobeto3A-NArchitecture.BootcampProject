...
public class UpdateApplicationStateCommand : IRequest<UpdatedApplicationStateResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
