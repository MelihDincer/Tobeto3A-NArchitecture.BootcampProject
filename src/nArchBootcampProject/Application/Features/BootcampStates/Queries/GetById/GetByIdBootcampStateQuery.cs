...
public class GetByIdBootcampStateQuery : IRequest<GetByIdBootcampStateResponse>, ISecuredRequest
{
    ...
    public class GetByIdBootcampStateQueryHandler : IRequestHandler<GetByIdBootcampStateQuery, GetByIdBootcampStateResponse>
    {
        ...
        public GetByIdBootcampStateQueryHandler(IMapper mapper, IBootcampStateRepository bootcampStateRepository, BootcampStateBusinessRules bootcampStateBusinessRules)
        {
            _mapper = mapper;
        ...
        public async Task<GetByIdBootcampStateResponse> Handle(GetByIdBootcampStateQuery request, CancellationToken cancellationToken)
        {
