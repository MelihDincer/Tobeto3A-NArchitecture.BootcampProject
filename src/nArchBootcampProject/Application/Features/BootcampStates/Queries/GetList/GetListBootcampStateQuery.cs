...
public class GetListBootcampStateQuery : IRequest<GetListResponse<GetListBootcampStateListItemDto>>, ISecuredRequest, ICachableRequest
{
    ...
    public class GetListBootcampStateQueryHandler : IRequestHandler<GetListBootcampStateQuery, GetListResponse<GetListBootcampStateListItemDto>>
    {
        ...
        public async Task<GetListResponse<GetListBootcampStateListItemDto>> Handle(GetListBootcampStateQuery request, CancellationToken cancellationToken)
        {
            ...
            GetListResponse<GetListBootcampStateListItemDto> response = _mapper.Map<GetListResponse<GetListBootcampStateListItemDto>>(bootcampStates);
            return response;
        }
    }
}