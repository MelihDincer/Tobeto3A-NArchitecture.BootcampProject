...
public class UpdateBootcampStateCommand : IRequest<UpdatedBootcampStateResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class UpdateBootcampStateCommandHandler : IRequestHandler<UpdateBootcampStateCommand, UpdatedBootcampStateResponse>
    {
        ...
        public UpdateBootcampStateCommandHandler(IMapper mapper, IBootcampStateRepository bootcampStateRepository,
        ...
        public async Task<UpdatedBootcampStateResponse> Handle(UpdateBootcampStateCommand request, CancellationToken cancellationToken)
        {
