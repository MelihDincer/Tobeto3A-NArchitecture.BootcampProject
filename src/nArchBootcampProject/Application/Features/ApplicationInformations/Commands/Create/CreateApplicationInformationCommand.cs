...
public class CreateApplicationInformationCommand : IRequest<CreatedApplicationInformationResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class CreateApplicationInformationCommandHandler : IRequestHandler<CreateApplicationInformationCommand, CreatedApplicationInformationResponse>
    {
        ...
        public CreateApplicationInformationCommandHandler(IMapper mapper, IApplicationInformationRepository applicationInformationRepository,
        ...
        public async Task<CreatedApplicationInformationResponse> Handle(CreateApplicationInformationCommand request, CancellationToken cancellationToken)
        {
            ...
            CreatedApplicationInformationResponse response = _mapper.Map<CreatedApplicationInformationResponse>(applicationInformation);
            return response;
        }
    }
}