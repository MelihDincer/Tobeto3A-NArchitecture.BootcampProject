...
public class GetByIdApplicationInformationQuery : IRequest<GetByIdApplicationInformationResponse>, ISecuredRequest
{
    ...
    public class GetByIdApplicationInformationQueryHandler : IRequestHandler<GetByIdApplicationInformationQuery, GetByIdApplicationInformationResponse>
    {
        ...
        public GetByIdApplicationInformationQueryHandler(IMapper mapper, IApplicationInformationRepository applicationInformationRepository, ApplicationInformationBusinessRules applicationInformationBusinessRules)
        {
            _mapper = mapper;
        ...
        public async Task<GetByIdApplicationInformationResponse> Handle(GetByIdApplicationInformationQuery request, CancellationToken cancellationToken)
        {
            ...
            GetByIdApplicationInformationResponse response = _mapper.Map<GetByIdApplicationInformationResponse>(applicationInformation);
            return response;
        }
    }
}